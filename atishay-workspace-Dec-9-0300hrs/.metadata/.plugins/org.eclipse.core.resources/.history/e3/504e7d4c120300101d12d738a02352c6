...
public final class Battle extends BaseBattle {
	...
	public void setup(RobotSpecification[] battlingRobotsList, BattleProperties battleProperties, 
		...
		/*
			...
			this.customRules = new CaptureTheFlagRules();
		}
		*/
	...
	public void setRoboObjects(List<RobjectPeer> robjects) {
		System.out.println("My rescuer has reached me ... Battle.java : setRoboObjects()");
		this.robjects = robjects;
	}

	public List<RobjectPeer> getRobjects() {
		if (robjects != null) {
			System.out.println("robjects is not null in Battle.java : getRobjects()");
			return robjects;
		}
		System.out.println("Someone is trying to improve me... Battle.java : getRobjects()");
